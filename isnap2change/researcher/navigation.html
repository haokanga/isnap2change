                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul id="schoolclass" class="collapse in nav nav-second-level" aria-expanded="true">
                                <li>
                                    <a href="school.php"><i class="fa fa-fw fa-mortar-board"></i>&nbsp;School Overview</a>
                                </li>
                                <li>
                                    <a href="class.php"><i class="fa fa-fw fa-users"></i>&nbsp;Class Overview</a>
                                </li>
                                <li>
                                    <a href="student.php"><i class="fa fa-fw fa-child"></i>&nbsp;Student Overview</a>
                                </li>
                                <li>
                                    <!--lock.php-->
                                    <a href="#"><i class="fa fa-fw fa-lock"></i>&nbsp;Weekly Locks</a>
                                </li>
                            </ul>
                            <!--/.nav-second-level -->
                        </li>                        
                        <li>
                            ...
                            <ul id="contenteditor" class="collapse in nav nav-second-level" aria-expanded="true">
                                <li>
                                    <a href="week.php"><i class="fa fa-fw fa-calendar"></i>&nbsp;Week Overview</a>
                                </li>
                                <li>
                                    <a href="quiz.php"><i class="fa fa-fw fa-book"></i>&nbsp;Quiz Overview</a>
                                </li>
                                <li>
                                    <a href="#.php"><i class="fa fa-fw fa-comment"></i>&nbsp;Fact Overview</a>
                                </li>
                                
                                <li>
                                    <a href="mcq.php"><i class="fa fa-fw fa-check"></i>&nbsp;MCQ Overview</a>
                                </li>
                                <!--
                                <li>
                                    <a href="saq.php"><i class="fa fa-fw fa-child"></i>&nbsp;SAQ Overview</a>
                                </li>
                                <li>
                                    <a href="student.php"><i class="fa fa-fw fa-child"></i>&nbsp;Student Overview</a>
                                </li>
