                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Quiz MetaData <span class="glyphicon glyphicon-plus pull-right" data-toggle="modal" data-target="#dialog"></span>
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Questions and Options <span class="glyphicon glyphicon-plus pull-right" data-toggle="modal" data-target="#dialog"></span>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatables">
                                    ...
                                    <?php for($i=0; $i<count($quizResult); $i++) {?>
                                        <tr class="<?php if($i % 2 == 0){echo "odd";} else {echo "even";} ?>">
                                            <td style="display:none"><?php echo $quizResult->QuizID ?></td>
                                            <td><?php echo $quizResult->Week ?></td>
                                            <td><?php echo $quizResult->TopicName ?></td>
                                            <td><?php echo getQuizPoints($quizResult->QuizID); ?></td>                                            
                                            <td><?php echo $quizResult->Questions ?><span class="glyphicon glyphicon-remove pull-right" aria-hidden="true"></span><span class="pull-right" aria-hidden="true">&nbsp;</span><span class="glyphicon glyphicon-edit pull-right" data-toggle="modal" data-target="#dialog" aria-hidden="true"></span></td>
                                        </tr>
                                    <?php } ?>    
                                    </tbody>
                                </table>
