...
$contentAdminPageList = array('Week', 'Quiz', 'SnapFact', 'MCQ', 'SAQ', 'Matching', 'Poster','Misc');
$contentAdminIconList = array('calendar', 'book', 'lightbulb-o', 'check', 'pencil', 'th-list', 'exclamation-triangle','exclamation-triangle');
